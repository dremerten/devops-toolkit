...
echo -e "   ${YELLOW}  devops-toolkit=$IMAGE_NAME:$VERSION -n devops-toolkit-production${NC}"
echo ""
echo "3. Monitor rollout:"
echo -e "   ${YELLOW}kubectl rollout status deployment/devops-toolkit -n devops-toolkit-production${NC}"
echo ""
